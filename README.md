...
- `MAX_NUM_PAGES_TO_ANALYZE` - переменная хранит максимальное количество страниц, которое будет анализировать скрипт на сайте [www.superjob.ru](http://www.superjob.ru). Максимальные и минимальные значения этой переменной можно уточнить на сайте [api.superjob.ru](https://api.superjob.ru). По умолчанию значение - 5
...
Для установки необходимо отредактировать файл .env, в котором заполнить SUPERJOB_SECRETKEY и MAX_NUM_PAGES_TO_ANALYZE.
